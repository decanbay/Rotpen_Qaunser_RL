...
struct SFc2_Non_linear_simulationInstanceStruct
{
  ...
  real_T (*c2_gpu_dv)[16];
  real_T (*c2_gpu_Zt)[22056];
  real_T (*c2_gpu_Yt)[22056];
  real_T (*c2_gpu_armPart_vertices_G_frame)[22056];
  ...
  real_T (*c2_b_gpu_Yt)[6516];
  real_T (*c2_b_gpu_pendPart_vertices_G_frame)[6516];
  real_T (*c2_b_gpu_Zt)[6516];
  real_T (*c2_b_gpu_Xt)[6516];
  real_T (*c2_c_gpu_pendPart_vertices_G_frame)[6516];
  real_T (*c2_c_gpu_Zt)[3744];
  real_T (*c2_gpu_drivePart_vertices_G_frame)[3744];
  real_T (*c2_c_gpu_Yt)[3744];
